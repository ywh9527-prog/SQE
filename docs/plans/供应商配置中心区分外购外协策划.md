...
```
┌─────────────────────────────────────────────────┐
│ 常兴（外购）      IQC   已启用  已启用  启用  [操作] │
└─────────────────────────────────────────────────┘
┌─────────────────────────────────────────────────┐
│ 常兴（外协）      IQC   已启用  已启用  启用  [操作] │
└─────────────────────────────────────────────────┘
```

**说明**：
- 只有外购或只有外协的供应商：供应商名称直接显示，如"旭航"、"森永"
- 既有外购又有外协的供应商：分类标识直接显示在供应商名称后面，如"常兴（外购）"和"常兴（外协）"
- 外购记录和外协记录分别显示在不同行
- 不需要单独的"数据类型"列
